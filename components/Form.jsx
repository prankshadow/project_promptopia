...
const Form = ({
  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      <h1 className='head_text text-left'><span className='blue_gradient'>{type} Posts</span></h1>
      <p className='desc text-left max-w-md'>
        {type} and share amazindg promps with he world, and let your imagination run wild with any AI-powered platform
      </p>
